...
{
    /// <summary>
    /// Cung c?p c�c ch?c nang x? l� d? li?u li�n quan d?n nh�n s? c?a h? th?n    
    /// </summary>
    public static class HRDataService
    {
        ...
        /// </summary>
        /// <param name="input">
        /// Thông tin tìm kiếm và phân trang (từ khóa tìm kiếm, trang cần hiển thị, sử dụng mới trang).
        /// </param>
        /// <returns>
        ...
        /// (không bỏ trùng với email của nhân viên khác).
        /// </summary>
